...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-graph-012-list-coloring-conjecture-697efba7-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GRAPH-012"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-graph-012-list-coloring-conjecture-697efba7-v1",
      "problem_contract_sha256": "1ad6283390af7ed9b8c27bcb4f726e6fd34ee587cb95e8acc8c79048e70541aa",
      "problem_id": "problem:um-graph-012-list-coloring-conjecture-697efba7",
      "route_id": "route:um-graph-012-list-coloring-conjecture-697efba7-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-graph-012-list-coloring-conjecture-697efba7-source-fidelity-01",
      "graph_id": "graph:um-graph-012-list-coloring-conjecture-697efba7-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-graph-012-list-coloring-conjecture-697efba7-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-graph-012-list-coloring-conjecture-697efba7-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For every graph, does the list chromatic index equal the chromatic index?"
          },
          "statement_sha256": "15ab06b202c4033e8cb65e67cc93d1702a16cdf24af96b374ee3f620b99a3f44"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-graph-012-list-coloring-conjecture-697efba7-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-graph-012-list-coloring-conjecture-697efba7-root",
      "route_id": "route:um-graph-012-list-coloring-conjecture-697efba7-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-graph-012-a06cafc1f4c3",
        "url": "https://www.unsolvedmath.com/problems/GRAPH-012"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
